...
If you want to report a new issue, please read the [FAQ](#faq) *first* and then fill out this [**issue report template**](https://github.com/AF-1/lms-virtuallibrarycreator/issues/new?template=bug_report.md&title=%5BISSUE%5D+).
<br><br><br><br>
